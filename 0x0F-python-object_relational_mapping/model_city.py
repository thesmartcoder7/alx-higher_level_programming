...
class City(Base):
    ...
    structure and properties of a city entity.

    Attributes:
        __tablename__ (str): The name of the database table for
        storing city records.
    ...
    Note:
        The class definition maps this model to the "cities"
        table in the database. This model has a foreign key
        relationship with the "states" table.
    """
