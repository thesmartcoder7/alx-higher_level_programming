...
class TestSquare(unittest.TestCase):
    ...
    def test_square_missing_args(self):
    ...
    def test_square_methods_inherited_from_rectangle(self):
    ...
    def test_square_wrong_attributes(self):
    ...
    def test_square_update_method_wrong_types(self):
    ...
    def test_square_to_dictionary_method_wrong_args(self):
